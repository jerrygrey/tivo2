...
define('HANDBRAKE_DVD', HANDBRAKE.' -i "%s" -o "%s.m4v" --title %d -e x265 --two-pass --keep-display-aspect --normalize-mix 1 --drc 1.5 --first-audio --previews "0:0" --comb --deinterlace --verbose=0 2>&1');
