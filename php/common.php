...
define('HANDBRAKE_SCAN', HANDBRAKE.' -i "%s" --title 0 --min-duration 600 --two-pass --audio-lang-list eng --first-audio --normalize-mix 1 --drc 1.5 --keep-display-aspect --native-language eng --native-dub 2>&1');
